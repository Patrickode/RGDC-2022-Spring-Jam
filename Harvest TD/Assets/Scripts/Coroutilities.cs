...
public static class Coroutilities
{
    ...
    /// <summary>
    /// Stops a coroutine if it is not null. If it <i>is</i> null (already stopped), this method does nothing.
    /// </summary>
    ...
    /// <param name="coroutine">The coroutine to try to stop.<br/>
    /// NOTE: If this is successfully stopped, it will be set to null.</param>
    /// <remarks><b>This overload will also nullify the reference to <paramref name="coroutine"/></b> if it isn't already null.<br/>
